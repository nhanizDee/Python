...
amt_received_for_selling = NUMBER_OF_SHARE * SELLING_PRICE

# commission from selling the share
commission_selling = amt_received_for_selling * COMMISSION_RATE

# total for selling
total_amt_received_selling = amt_received_for_selling + commission_selling

# profit/loss
profit_loss = total_amt_received_selling - total_paid
...
print("Amount for selling: $", format(amt_received_for_selling, '.2f'))
