...
while True:
    ...
    em_num = int(input('Enter employee number(enter 0 to quit): ')) # em number will be any that > 0, if 0 appear thenit end of the loop
    ...
    fica_wth_wth = float(input('Enter the FICA withholding: ')) # FICA withholding
